        ...
        <div className='w-4/5 mx-auto py-5'>
            ...
            <div className='bg-gray-100 rounded-md p-8'>
                <div className='flex justify-between items-center'>
                    <h1 className='text-xl font-bold'>All Porducts: {products.length}</h1>
                    {
                        select?.length ? <button onClick={handleSelectedProducts} className='btn btn-error'>Delete Selectd Product</button> : <></>
                    }
                    <Link to='/addproduct' className='text-xl font-semibold bg-success px-3 py-2 rounded-md hover:bg-green-600 duration-300 hover:text-white '>Add Product</Link>
                </div>
                <hr className='border-b-2 border-gray-400 my-2' />
